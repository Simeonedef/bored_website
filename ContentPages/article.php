...
$articleDetail;
$title; $subtitle; $article; $author;
if(!isset($_GET['content']))
  $contentName = $login->getContent();
else
  $contentName = $_GET['content'];
if($contentName != null)
  $articleDetail = $dbClass->getArticle($contentName);
else
...
{
  $title = $articleDetail['ContentName'];
...
<?php echo $article; ?>                           
            	...
            	<div class="page-header-wrapper">
             	...
             	<div class="container">
                	<div class="row">
                        <div class="cf2"><?php echo '<a href="../redirect.php?last='.$contentName .'">'; ?>
 <img src="./../img/bt-ty.png" id="button" class="buttonmain" onmouseover="document.getElementById('button').src='./../img/button-pressed.png'" onmouseout="document.getElementById('button').src='./../img/bt-ty.png'" onclick="document.getElementById('rating_form').submit(); return false;"/> </a>
                         </div>
                  	</div>
                </div>
