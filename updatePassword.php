...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
  if(isset($_POST['button']))
  {
    ...
    if($email != $storedmail)
    {
      $emailError = "This user has not asked for a password reset";
      $valid = FALSE;
    }

    if($code != $dbClass->getResetKey($email))
    {
      $passwordError = "The code is incorrect";
      $valid = FALSE;
    }	
    ...
    if($valid == TRUE)
    {
      $dbClass->updatePassword($password, $email);
      $dbClass->deleteKey($email);
      		...
      		<div class="panel panel-default">
				...
				<div class="extra-space-m"></div>
  				...
  				<div class="panel-body">
  			    	<form accept-charset="UTF-8" id="password-form" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?email='.$storedmail;?>">
                      <fieldset>
  			    		<div class="form-group">
  			    			<input class="form-control" placeholder="Code received by email" name="code" type="text">
  			    		</div>
                <div class="form-group">
                  <input class="form-control" placeholder="Retype Email" name="thisEmail" type="email">
                </div>  
					<div class="form-group">
  			    			<input class="form-control" placeholder="Password" name="password" type="password">
  			    		</div>
                			<div class="form-group">
  			    			<input class="form-control" placeholder="Retype password" name="passwordagain" type="password">
  			    		</div>
					<div class="extra-space-m"></div>
  			    		<input class="btn btn-lg btn-success btn-block" name = "button" type="submit" value="Submit now">
  			    	</fieldset>
  			      	</form>
              </div>
            </div>
                    	...
                    	<div class="row wow bounceInLeft" data-wow-delay="0.4s">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <ul class="imp-links">
                                	...
                                	<li><a href="contact.php">AContact us</a></li>
