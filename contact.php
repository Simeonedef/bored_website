...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
  ...
  { 
    ...
    $thisSubject = trim($_POST['thisSubject']);
    $message = trim($_POST['query']);

    $to = "bored@actilis.org";
    $subject = $thisSubject;
    $txt = $message;
    $header = 'From: '.$email;
    ...
    if(!isset($email))
    {
      $emailError = "Please type in an email";
      $valid = FALSE;
    }
    ...
    if(!isset($thisSubject))
    {
      $subjectError = "Please include a subject";
      $valid = FALSE;
    }
    if(!isset($message))
    {
      $messageError = "Please type in a message";
      $valid = FALSE;
    }
...
<div class="extra-space-xl"></div>
  ...
  <div class="panel-body">
  			    	<form accept-charset="UTF-8" role="form" method="post" id="contat_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                      <fieldset>
  			    		<div class="form-group">
  			    			<input class="form-control" placeholder="Email Address" name="email" id="email" type="email"><?php echo $emailError;?>
  			    		</div>
                		<div class="form-group">
  			    			<input class="form-control" placeholder="Subject" name="thisSubject" id="subject" type="text"><?php echo $subjectError;?>
  			    		</div>
                        <div class="form-group">
  			    			<textarea class="form-control" placeholder="Type your message here" name="query" rows="7"></textarea><?php echo $messageError;?>
  			    		</div>
